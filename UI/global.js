...
function adding(){
    ...
    if(I.add({descriprion:addForm.descr.value,photoLink:document.getElementById('preview').src,author:view.getName(),hashTags:addForm.tags.value.split(",")})){
        document.getElementById("head").className="show";
...
function editPost(id){
    ...
    document.getElementById("added").addEventListener("click",function(){
        let addForm=document.getElementById("addPostss");
        if(I.edit(id,{descriprion:addForm.descr.value,photoLink:document.getElementById('preview').src,hashTags:addForm.tags.value.split(",")})){
            document.getElementById("head").className="show";
            document.getElementById('addPost').className="noone";
            addForm.descr.value="";
            addForm.photoLink.value="";
